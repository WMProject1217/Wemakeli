...
$wmui_backpath = "../";
echo "<script src='$wmsys_asset/wmui/js/jquery-3.4.1.min.js'></script>";
echo "<script src='$wmsys_asset/wmui/wmuijs'></script>";
...
<?
//print "Build on Wemakeli Danmaku Video Website System [Version 0.8.7 Build 992]<br>By WMProject1217<br>";
